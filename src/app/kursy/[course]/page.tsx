...
export const courses: Course[] = [
	{
		...
		headData: {
			title:
				"Kodujemy w biurze | Podstawy Javascript. Pierwsza aplikacja w konsoli",
			ogTitle:
				"Kodujemy w biurze | Podstawy Javascript. Pierwsza aplikacja w konsoli",
			description:
		...
		heroSectionData: {
			...
			btnHref:
				"/kursy/javascript/wprowadzenie-czym-jest-javascript-i-dlaczego-warto-sie-go-uczyc",
			btnCTA: "Zacznij kurs!",
			imgSrc: "",
		},
	},
	{
		...
		headData: {
			title:
				"Kodujemy w biurze | Javascript i Local Storage. Przechowujemy dane w przeglądarce",
			ogTitle:
				"Kodujemy w biurze | Javascript i Local Storage. Przechowujemy dane w przeglądarce",
			description:
		...
		heroSectionData: {
			h1FirstSmallText: "Darmowy kurs",
			h1LargeText:
				"Javascript i Local Storage. Przechowujemy dane w przeglądarce",
			descriptionParagraphs: [
	...
	},
	{
		...
		headData: {
			title:
				"Kodujemy w biurze | Podstawy HTML. Pierwsza statyczna strona internetowa",
			ogTitle:
				"Kodujemy w biurze | Podstawy HTML. Pierwsza statyczna strona internetowa",
			description:
...
export async function generateMetadata({
	...
	const { title, description, ogDescription, ogImage, ogTitle, ogUrl } =
		pageData.headData;
...
export default async function Page({
	...
	if (!course)
		return <p style={{ color: "red" }}>Niestety nie ma takiego kursu...</p>;
